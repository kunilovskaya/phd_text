...
However, the alternative annotation tools (such as Appraise \cite{Federmann2010}\wlvfootnote{\url{https://github.com/cfedermann/Appraise}}) are even less suitable as they can be restricted as to the length of annotated items or are more cumbersome to install and get access to (\textit{BLAST}~\cite{Stymne2011}, \textit{MT-EquAl}~\cite{Girardi2014}\wlvfootnote{\url{https://github.com/hltfbk/MT-EQuAl}}, \textit{ACCOL\'E}~\cite{EsperancaRodier2019}\wlvfootnote{\url{https://lig-accole.imag.fr/app.php/login}}).

\documentclass[12pt,a4paper,twoside,openright]{report} % uses the default cls report, no separate cls file:  ,twoside,openright
...
\usepackage[a4paper,inner=25mm,outer=25mm, top=20mm]{geometry} % recto and verso pages
...
\thesistitle{Translationese indicators \\for human translation quality estimation \\(based on English-to-Russian translation \\of mass-media texts)} {Maria Kunilovskaya} {December 2022}
...
%\pagestyle{fancy} % this is used after \usepackage{fancyhdr} and before \fancyhead[RO,LE]{Thesis Title}
